...
nb_images = 36; 
nombre = input('Entrez un nombre entre 1 et 36: ');
while nombre < 1 || nombre > 36
    nombre = input('Le nombre doit être entre 1 et 36, veuillez réessayer : ');
end
disp(['Vous avez entré le nombre ' num2str(nombre)]);
