...
(*  Les Affectables *)
(* dans ce projet, Ident n'apparait plus dans Expression, on le traite ici*)
...
type expression =
  ...
  (* Décision de traiter la surcharge-> traité en partiel de TDL*)
 ...
 (* Entier *)
  ...
  (* NULL ---> traitement des pointeurs *)
  | Null
  (* New---> traitement des pointeurs *)
  | New of typ
  (* Adresse ---> traitement des pointeurs *)
  | Adresse of string
    (* Tid --> traitement de la conditionnelle ternaire  *)
...
and instruction =
  ...
  (* traitement de la conditionnelle sans de bloc else*)
  ...
  (* Boucle loop à la Rust avec étiquette*)
  | Loop_etiquette of string * bloc
  (* Break associé à un Loop Rust avec une etiquette *)
  | Break_etiquette of string
  (* Continue associé à un Loop Rust avec une etiquette *)
  | Continue_etiquette of string 
  (* Boucle loop à la Rust sans étiquette*)
  | Loop of bloc 
  (* Break associé à un Loop Rust sans etiquette *)
  | Break
  (* Continue associé à un Loop Rust sans etiquette *)
  | Continue
...
| Valeur of affectable
  ...
  type expression =
    ...
    |New of typ
    |Null
    (* On remplace String par l'info Info_ast*)
