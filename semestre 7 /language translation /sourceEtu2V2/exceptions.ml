...
exception MauvaiseUtilisationIdentifiant of string 
 exception BreakDejaDeclare of string
  exception MauvaisLoopBreak
  exception MauvaisContinueLoop
  exception ContinueDejaDeclare of string
...
exception BreakLoopDansMain
exception ErreurInterne 
exception NotAPointer
exception ContinueLoopDansMain
