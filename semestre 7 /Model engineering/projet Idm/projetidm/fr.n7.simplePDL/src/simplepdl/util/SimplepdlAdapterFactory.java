...
public class SimplepdlAdapterFactory extends AdapterFactoryImpl {
	...
	protected SimplepdlSwitch<Adapter> modelSwitch =
		new SimplepdlSwitch<Adapter>() {
			...
			@Override
			public Adapter caseRessourcesRequise(RessourcesRequise object) {
				return createRessourcesRequiseAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link simplepdl.RessourcesRequise <em>Ressources Requise</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createRessourcesRequiseAdapter() {
		return null;
	}
