...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 * @generated
	 */
	private EClass ressourcesRequiseEClass = null;
	 ...
	 * @generated
	 */
	public EReference getWorkDefinition_LinkToRessources() {
	 ...
	 * @generated
	 */
	public EClass getRessourcesRequise() {
		return ressourcesRequiseEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getRessourcesRequise_Nb() {
		return (EAttribute)ressourcesRequiseEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getRessourcesRequise_Ressourceutilise() {
		return (EReference)ressourcesRequiseEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getRessourcesRequise_RessourcePredecessor() {
		return (EReference)ressourcesRequiseEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(workDefinitionEClass, WORK_DEFINITION__LINK_TO_RESSOURCES);
		...
		ressourcesRequiseEClass = createEClass(RESSOURCES_REQUISE);
		createEAttribute(ressourcesRequiseEClass, RESSOURCES_REQUISE__NB);
		createEReference(ressourcesRequiseEClass, RESSOURCES_REQUISE__RESSOURCEUTILISE);
		createEReference(ressourcesRequiseEClass, RESSOURCES_REQUISE__RESSOURCE_PREDECESSOR);
	...
	public void initializePackageContents() {
		...
		initEReference(getWorkDefinition_LinkToRessources(), this.getRessourcesRequise(), null, "linkToRessources", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(ressourcesRequiseEClass, RessourcesRequise.class, "RessourcesRequise", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getRessourcesRequise_Nb(), ecorePackage.getEInt(), "nb", null, 1, 1, RessourcesRequise.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRessourcesRequise_Ressourceutilise(), this.getRessource(), null, "ressourceutilise", null, 1, 1, RessourcesRequise.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRessourcesRequise_RessourcePredecessor(), this.getWorkDefinition(), null, "ressourcePredecessor", null, 1, 1, RessourcesRequise.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
