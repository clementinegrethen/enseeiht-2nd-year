...
public class SimplepdlFactoryImpl extends EFactoryImpl implements SimplepdlFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SimplepdlPackage.RESSOURCES_REQUISE: return createRessourcesRequise();
			default:
	 ...
	 * @generated
	 */
	public RessourcesRequise createRessourcesRequise() {
		RessourcesRequiseImpl ressourcesRequise = new RessourcesRequiseImpl();
		return ressourcesRequise;
	}
