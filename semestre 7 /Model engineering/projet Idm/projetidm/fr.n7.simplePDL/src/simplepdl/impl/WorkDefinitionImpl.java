 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getLinkToRessources <em>Link To Ressources</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	...
	/**
	 * The cached value of the '{@link #getLinkToRessources() <em>Link To Ressources</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getLinkToRessources()
	 * @generated
	 * @ordered
	 */
	protected EList<RessourcesRequise> linkToRessources;
	 ...
	 * @generated
	 */
	public EList<RessourcesRequise> getLinkToRessources() {
		if (linkToRessources == null) {
			linkToRessources = new EObjectContainmentEList<RessourcesRequise>(RessourcesRequise.class, this, SimplepdlPackage.WORK_DEFINITION__LINK_TO_RESSOURCES);
		}
		return linkToRessources;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__LINK_TO_RESSOURCES:
				return ((InternalEList<?>)getLinkToRessources()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__NAME:
				...
				return;
			case SimplepdlPackage.WORK_DEFINITION__LINK_TO_RESSOURCES:
				getLinkToRessources().clear();
				getLinkToRessources().addAll((Collection<? extends RessourcesRequise>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__LINK_TO_RESSOURCES:
				return linkToRessources != null && !linkToRessources.isEmpty();
		}
