 ...
 *   <li>{@link simplepdl.WorkDefinition#getLinkToRessources <em>Link To Ressources</em>}</li>
 * </ul>
 *
...
public interface WorkDefinition extends ProcessElement {
	...
	/**
	 * Returns the value of the '<em><b>Link To Ressources</b></em>' containment reference list.
	 * The list contents are of type {@link simplepdl.RessourcesRequise}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Link To Ressources</em>' containment reference list.
	 * @see simplepdl.SimplepdlPackage#getWorkDefinition_LinkToRessources()
	 * @model containment="true"
	 * @generated
	 */
	EList<RessourcesRequise> getLinkToRessources();
