...
public interface SimplepdlPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Link To Ressources</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int WORK_DEFINITION__LINK_TO_RESSOURCES = PROCESS_ELEMENT_FEATURE_COUNT + 3;
	...
	/**
	 * The meta object id for the '{@link simplepdl.impl.RessourcesRequiseImpl <em>Ressources Requise</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see simplepdl.impl.RessourcesRequiseImpl
	 * @see simplepdl.impl.SimplepdlPackageImpl#getRessourcesRequise()
	 * @generated
	 */
	int RESSOURCES_REQUISE = 6;
	 ...
	 * @ordered
	 */
	int RESSOURCES_REQUISE__NB = 0;

	/**
	 * The feature id for the '<em><b>Ressourceutilise</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESSOURCES_REQUISE__RESSOURCEUTILISE = 1;

	/**
	 * The feature id for the '<em><b>Ressource Predecessor</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESSOURCES_REQUISE__RESSOURCE_PREDECESSOR = 2;

	/**
	 * The number of structural features of the '<em>Ressources Requise</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESSOURCES_REQUISE_FEATURE_COUNT = 3;

	/**
	 * The number of operations of the '<em>Ressources Requise</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESSOURCES_REQUISE_OPERATION_COUNT = 0;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link simplepdl.WorkDefinition#getLinkToRessources <em>Link To Ressources</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Link To Ressources</em>'.
	 * @see simplepdl.WorkDefinition#getLinkToRessources()
	 * @see #getWorkDefinition()
	 * @generated
	 */
	EReference getWorkDefinition_LinkToRessources();
	...
	/**
	 * Returns the meta object for class '{@link simplepdl.RessourcesRequise <em>Ressources Requise</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Ressources Requise</em>'.
	 * @see simplepdl.RessourcesRequise
	 * @generated
	 */
	EClass getRessourcesRequise();

	/**
	 * Returns the meta object for the attribute '{@link simplepdl.RessourcesRequise#getNb <em>Nb</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Nb</em>'.
	 * @see simplepdl.RessourcesRequise#getNb()
	 * @see #getRessourcesRequise()
	 * @generated
	 */
	EAttribute getRessourcesRequise_Nb();

	/**
	 * Returns the meta object for the reference '{@link simplepdl.RessourcesRequise#getRessourceutilise <em>Ressourceutilise</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Ressourceutilise</em>'.
	 * @see simplepdl.RessourcesRequise#getRessourceutilise()
	 * @see #getRessourcesRequise()
	 * @generated
	 */
	EReference getRessourcesRequise_Ressourceutilise();

	/**
	 * Returns the meta object for the reference '{@link simplepdl.RessourcesRequise#getRessourcePredecessor <em>Ressource Predecessor</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Ressource Predecessor</em>'.
	 * @see simplepdl.RessourcesRequise#getRessourcePredecessor()
	 * @see #getRessourcesRequise()
	 * @generated
	 */
	EReference getRessourcesRequise_RessourcePredecessor();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Link To Ressources</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference WORK_DEFINITION__LINK_TO_RESSOURCES = eINSTANCE.getWorkDefinition_LinkToRessources();
		...
		/**
		 * The meta object literal for the '{@link simplepdl.impl.RessourcesRequiseImpl <em>Ressources Requise</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see simplepdl.impl.RessourcesRequiseImpl
		 * @see simplepdl.impl.SimplepdlPackageImpl#getRessourcesRequise()
		 * @generated
		 */
		EClass RESSOURCES_REQUISE = eINSTANCE.getRessourcesRequise();
		 ...
		 * @generated
		 */
		EAttribute RESSOURCES_REQUISE__NB = eINSTANCE.getRessourcesRequise_Nb();

		/**
		 * The meta object literal for the '<em><b>Ressourceutilise</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference RESSOURCES_REQUISE__RESSOURCEUTILISE = eINSTANCE.getRessourcesRequise_Ressourceutilise();

		/**
		 * The meta object literal for the '<em><b>Ressource Predecessor</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference RESSOURCES_REQUISE__RESSOURCE_PREDECESSOR = eINSTANCE.getRessourcesRequise_RessourcePredecessor();
