...
public class PetrinetSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PetrinetPackage.PLACE: {
				...
				if (result == null) result = caseBoite(place);
			...
			case PetrinetPackage.TRANSITION: {
				...
				if (result == null) result = caseBoite(transition);
				if (result == null) result = casePetriElement(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetPackage.BOITE: {
				Boite boite = (Boite)theEObject;
				T result = caseBoite(boite);
				if (result == null) result = casePetriElement(boite);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetrinetPackage.READ_ARC: {
				...
				if (result == null) result = casePetriElement(readArc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Boite</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Boite</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBoite(Boite object) {
		return null;
	}
