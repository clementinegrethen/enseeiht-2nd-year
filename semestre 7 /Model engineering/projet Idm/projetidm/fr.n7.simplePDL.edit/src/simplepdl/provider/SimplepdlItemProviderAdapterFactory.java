...
public class SimplepdlItemProviderAdapterFactory extends SimplepdlAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link simplepdl.RessourcesRequise} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected RessourcesRequiseItemProvider ressourcesRequiseItemProvider;

	/**
	 * This creates an adapter for a {@link simplepdl.RessourcesRequise}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createRessourcesRequiseAdapter() {
		if (ressourcesRequiseItemProvider == null) {
			ressourcesRequiseItemProvider = new RessourcesRequiseItemProvider(this);
		}

		return ressourcesRequiseItemProvider;
	}
	...
	public void dispose() {
		...
		if (ressourcesRequiseItemProvider != null) ressourcesRequiseItemProvider.dispose();
	}
