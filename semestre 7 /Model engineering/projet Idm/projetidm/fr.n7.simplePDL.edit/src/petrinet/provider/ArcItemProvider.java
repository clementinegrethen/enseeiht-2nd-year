...
public class ArcItemProvider extends PetriElementItemProvider {
	...
	protected void addNbJetonsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Arc_nbJetons_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Arc_nbJetons_feature", "_UI_Arc_type"),
				 PetrinetPackage.Literals.ARC__NB_JETONS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Arc arc = (Arc)object;
		return getString("_UI_Arc_type") + " " + arc.getNbJetons();
	}
